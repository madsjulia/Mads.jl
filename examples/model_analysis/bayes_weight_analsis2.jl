...
for i = 1:3
	...
	for w = (1000, 100, 10, 1)
		...
		mcmcchain = Mads.bayessampling(md; nsteps=10000000, burnin=1000, thinning=1000, seed=2016)
		Mads.scatterplotsamples(md, mcmcchain.value', "bayes_results/bayes_opt2_$(optnames[i])_w$w.png")
		o = Mads.forward(md, mcmcchain.value)
		Mads.spaghettiplot(md, o, filename="bayes_results/bayes_opt2_$(optnames[i])_w$(w)_spaghetti.png")
		...
		Gadfly.draw(Gadfly.PNG("bayes_results/bayes_opt2_$(optnames[i])_w$(w)_o5.png", 6Gadfly.inch, 4Gadfly.inch), f)
	end
end
