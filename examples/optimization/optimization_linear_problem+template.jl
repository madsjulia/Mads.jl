...
@Base.Test.test isapprox(results[1]["a"], 3.9157540, atol=1e-6)
@Base.Test.test isapprox(results[1]["b"], 6.4208030, atol=1e-6)
@Base.Test.test isapprox(results[1]["c"], -1.0, atol=1e-6)
