...
mdsobol = Mads.loadmadsfile("test-sobol.mads")
...
mdsaltelli = Mads.loadmadsfile("test-saltelli.mads")
...
# mdsaltelli = Mads.loadmadsfile("tests/test-sobol.mads")
...
# mdsaltelli = Mads.loadmadsfile("tests/test-saltelli.mads")
