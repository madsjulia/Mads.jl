...
argtext=Dict("filename"=>"amanzi input file name",
            "nproc"=>"number of processor to be used by Amanzi [default=`Mads.nprocs_per_task`]",
...
"""
function amanzi(filename::String, nproc::Int=Mads.nprocs_per_task, quiet::Bool=Mads.quiet, observation_filename::String="observations.out", setup::String="source-amanzi-setup"; amanzi_exe::String="")
	if quiet
