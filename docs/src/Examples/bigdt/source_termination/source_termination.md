...
The figures are generated by the [`examples/bigdt/source_termination.jl`](https://github.com/madsjulia/Mads.jl/blob/master/examples/bigdt/source_termination.jl) script.
...
![Plan view of the contaminant source and three monitoring wells](w01-problemsetup.svg)
