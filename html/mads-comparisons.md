...
$> _mads s02 ldebug_
MADS: Model Analyses & Decision Support (v1.6) 2026
---------------------------------------------------
...
For this example, the code **WELLS** is needed; **WELLS** can be obtained at [wells.gitlab.io](https://wells.gitlab.io/)
