...
function cmadsins_obs(obsid::AbstractVector, instructionfilename::AbstractString, inputfilename::AbstractString)
	...
	result = ccall((:ins_obs, "libmads"), Int32, (Int32, Ptr{Ptr{UInt8}}, Ptr{Float64}, Ptr{Float64}, Ptr{UInt8}, Ptr{UInt8}, Int32), n, obsid, obsval, obscheck, instructionfilename, inputfilename, debug)
