...
\begin{document}
    ...
    \hypertarget{mads-notebook-example-contamination-problem}{%
\section{Mads Notebook: Example Contamination
Problem}\label{mads-notebook-example-contamination-problem}}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{contamination_files/contamination_9_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{contamination_files/contamination_15_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{contamination_files/contamination_19_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{contamination_files/contamination_26_0.png}
    \end{center}
    { \hspace*{\fill} \\}
