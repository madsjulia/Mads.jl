...
Mads.plotseries(S, "disturbance_original_signals.png", xtitle="Time", title="", name="", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch, colors=["red", "blue", "green"])
H = [[1,1,1] [0,2,1] [0,2,1] [1,0,2] [2,0,1] [1,2,0] [2,1,0]]
X = S * H
Mads.plotseries(X, "disturbance_mixed_observations.svg", xtitle="Time", title="Mixed observations", name="Observation", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch, colors=["cyan", "black", "orange", "purple", "magenta", "brown", "gray"])
Mads.plotseries(X, "disturbance_mixed_observations.png", xtitle="Time", title="", name="", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch, colors=["cyan", "black", "orange", "purple", "magenta", "brown", "gray"])
# info("Reconstruction of sin/rand signals using NMF ...")
# Wnmf, Hnmf, pnmf = Mads.NMFm(X, nk, retries=1)
...
# Mads.plotseries(Wnmf * Hnmf, "sig_reproduced_observations_nmf.svg", title="Reproduced observations", name="Signal", combined=true)
info("Reconstruction of sin/rand disturbance signal using JuMP/NLopt ...")
Wipopt, Hipopt, pipopt = Mads.NMFipopt(X, nk, retries=1)
...
Mads.plotseries(Wipopt * Hipopt, "disturbance_reproduced_observations_ipopt.svg", xtitle="Time", title="Reproduced observations", name="Observation", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch, colors=["cyan", "black", "orange", "purple", "magenta", "brown", "gray"])
Mads.plotseries(Wipopt * Hipopt, "disturbance_reproduced_observations_ipopt.png", xtitle="Time", title="", name="", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch, colors=["cyan", "black", "orange", "purple", "magenta", "brown", "gray"])
