...
Mads.plotseries(Wipopt, "rand_unmixed_sources_ipopt.svg", title="Unmixed sources", name="Source", combined=false)
...
Wipopt, Hipopt, pipopt = Mads.NMFipopt(X, nk, retries=R)
Mads.plotseries(Wipopt, "sin_unmixed_sources_ipopt.svg", title="Unmixed sources", name="Source", combined=true)
Mads.plotseries(Wipopt * Hipopt, "sin_reproduced_signals_ipopt.svg", title="Reproduced signals", name="Signal", combined=true)
...
# Mads.plotseries(S, "sig_original_sources.png", title="Original sources", name="Source", combined=true)
X = S * H
Mads.plotseries(X, "sig_mixed_signals.svg", title="Mixed signals", name="Signal", combined=true)
# Mads.plotseries(X, "sig_mixed_signals.png", title="Mixed signals", name="Signal", combined=true)
...
# Mads.plotseries(Wnmf, "sig_unmixed_sources_nmf.png", title="Unmixed sources", name="Source", combined=true)
...
Mads.plotseries(Wipopt, "sig_unmixed_sources_ipopt.svg", title="Unmixed sources", name="Source", combined=true)
# Mads.plotseries(Wipopt, "sig_unmixed_sources_ipopt.png", title="Unmixed sources", name="Source", combined=true)
Mads.plotseries(Wipopt * Hipopt, "sig_reproduced_signals_ipopt.svg", title="Reproduced signals", name="Signal", combined=true)
