...
Mads.plotmatches(md, forward_predictions; xtitle="Time [a]", ytitle="Concentration [ppb]", separate_files=true) # plot initial matches
# for w in Mads.getwellkeys(md)
# 	Mads.display("w01_match_$(w).svg")
# end
...
Mads.plotmatches(md, inverse_predictions; xtitle="Time [a]", ytitle="Concentration [ppb]", separate_files=true) # plot calibrated matches
...
mcmcchain = Mads.emceesampling(md; seed=20151001)
...
mcmcvalues = Mads.paramarray2dict(md, permutedims(mcmcchain[1]))
...
Mads.plotmatches(md_new, new_forward_predictions; filename=rootname * "-new-problem.svg", xtitle="Time [a]", ytitle="Concentration [ppb]", separate_files=true) # plot matches for the new problem
...
Mads.plotobsSAresults(md, saltelli_results; filter=r"w13a", filename="w13a-saltelli.svg", xtitle="Time [a]", ytitle="Concentration [ppb]")
# Mads.display("w13a-saltelli.svg")
Mads.plotobsSAresults(md, saltelli_results; filter=r"w20a", filename="w20a-saltelli.svg", xtitle="Time [a]", ytitle="Concentration [ppb]")
...
Mads.plotobsSAresults(md, efast_results; filter=r"w13a", filename="w13a-efast.svg", xtitle="Time [a]", ytitle="Concentration [ppb]")
# Mads.display("w13a-efast.svg")
Mads.plotobsSAresults(md, efast_results; filter=r"w20a", filename="w20a-efast.svg", xtitle="Time [a]", ytitle="Concentration [ppb]")
