...
@Base.Test.testset "Minimization" begin
	@Base.Test.test isapprox(minimizer_a1[1], 1.3237; atol=1e-2)
	@Base.Test.test isapprox(minimizer_l1[1], 1.3225; atol=1e-2)
	@Base.Test.test isapprox(minimizer_a2[1], 2.017; atol=1e-2)
	@Base.Test.test isapprox(minimizer_a2[2], 0.972; atol=1e-2)
	@Base.Test.test isapprox(minimizer_l2[1], 2.016; atol=1e-2)
	@Base.Test.test isapprox(minimizer_l2[2], 0.972; atol=1e-2)
end
:passed