...
info("Parameter transformation: $a -> $Mads.sinetransform(a, lowerbounds, upperbounds)\n")
...
info("Parameter transformation in a function: $a = $Mads.rosenbrock_lm([2.0,2.0])\n")
a = sin_rosenbrock_lm(Mads.asinetransform([1.0,1.0], lowerbounds, upperbounds, indexlogtransformed))
info("Parameter transformation in a function: $a = $Mads.rosenbrock_lm([1.0,1.0])\n")
