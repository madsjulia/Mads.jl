...
function welcome()
	...
	println("$(bl)MADS$(tx) performs Sensitivity Analysis, Parameter Estimation, Model Inversion and Calibration, Uncertainty Quantification, Model Selection and Model Averaging, Model Reduction and Surrogate Modeling, Machine Learning, Decision Analysis and Support.")
end
...
"""
function help()
	Markdown.parse_file(joinpath(Mads.dir, "docs", "src", "Getting_Started.md"))
end
...
"""
function copyright()
	Markdown.parse_file(joinpath(Mads.dir, "LICENSE"))
end
