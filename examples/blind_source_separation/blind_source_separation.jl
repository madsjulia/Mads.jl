...
s3[70:end] = 0
S = [s1 s2 s3]
Mads.plotseries(S, "disturbance_original_signals.svg", xtitle="Time", title="Original signals", name="Signal", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch)
...
X = S * H
Mads.plotseries(X, "disturbance_mixed_observations.svg", xtitle="Time", title="Mixed observations", name="Observation", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch)
...
info("Reconstruction of sin/rand signals using JuMP/NLopt ...")
Wipopt, Hipopt, pipopt = Mads.NMFipopt(X, nk, retries=1)
Mads.plotseries(Wipopt[:,[2,1,3]], "disturbance_unmixed_signals_ipopt.svg", xtitle="Time", title="Unmixed signals", name="Signal", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch)
Mads.plotseries(Wipopt[:,[2,1,3]], "disturbance_unmixed_signals_ipopt.png", xtitle="Time", title="", name="", combined=true, hsize=8Gadfly.inch, vsize=4Gadfly.inch)
