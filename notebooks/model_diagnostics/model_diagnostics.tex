...
Number of optimizable parameters: 4
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{model_diagnostics_files/model_diagnostics_45_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
└ @ Base loading.jl:1317
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{model_diagnostics_files/model_diagnostics_53_1.png}
    \end{center}
    { \hspace*{\fill} \\}
